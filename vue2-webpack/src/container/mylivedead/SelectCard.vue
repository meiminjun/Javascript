<template>
    <div>
        <div class="pec-mask" style="display: none;" :style="{display:MaskShow?'block':'none'}"></div>
        <div class="pec-pop-picker" style="transition: all 1s;bottom:-100%" :style="{bottom:pickerBottom}">
            ...
            <div class="pec-picker-list">
                <div class="pec-picker-item" v-for="(item, index) in selectData.data"  @click="selectValue" :data-index="index">
                    ...
                    <div class="pec-picker-item-body">
                        <p>{{item.bankName}} (尾号{{item.bankCardMask | changeNo}})</p>
                    </div>
