<template id="template">
  <div>
    ...
    <section>
      ...
      <!--<p>分享</p></div>-->
      <!--<div class="pec-btn-zone pec-fiexd-btn">-->
      <!--<button @click="forward" style="with:45%;height:0.9rem" size="big" class="pec-primary-btn">支取</button>-->
      <!--<button @click="forward" style="with:45%;height:0.9rem" size="big" class="pec-primary-btn">存入</button>-->
      <!--</div>-->
    </section>
  </div>
</template>
...
//    },
  created: function () {
    ...
    //TODO： 请求数据回来
    me.getAipRecommend();
    deposit_detail.default.getCreateOrder({
    ...
    deposit_detail.default.queryDrawHistory({
      url: 'queryDrawHistory',
      qs: {
        businessType: '00',
        ccy: 'RMB',
  ...
  ...
    mapActions([
      ...
      forward: function () {
        ...
        deposit_detail.default.dhtQueryCardList({
          ...
          if (res.length > 0) {
//            ald.nav.forward({url: 'depositBuy'});
