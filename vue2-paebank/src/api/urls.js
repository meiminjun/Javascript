...
const hostname = {
  dev: {
    ...
    news: '',
    static: 'http://bank-static-stg.pingan.com.cn:8480/aum_dhlc/pages/dev/deposit/mobile'
  },
  stg: {
    paebank: 'https://ibp-uat5.pingan.com.cn',
    rmb: 'https://rmb-stg.pingan.com.cn',
    news: 'http://stg5.pingan.com.cn:60880',
    static: 'http://bank-static-stg.pingan.com.cn:8480/aum_dhlc/pages/stg2/deposit/mobile'
  },
  prd: {
    paebank: 'https://bank.pingan.com.cn',
...
export default {
  ...
  records: 'https://rmb-stg2.pingan.com.cn:6443/bron/ibank/cust/bron-ibank-pd/dhtCommon/queryDrawDetail.do',
  ...
  // 我的定活通
  mylivedead: hostname['dev'].rmb + (ENV == 'stg' ? '/bron/ibank/cust/bron-ibank-pd/superDht/checkLogin/queryDHBHold.do' : 'mylivedead.json'),
  // 收银台获取银行卡列表
  mylivedead_card: hostname['dev'].rmb + (ENV == 'stg' ? '/bron/ibank/cust/bron-ibank-pd/dhtCommon/checkLogin/dhtQueryCardList.do' : 'mylivedead_card.json'),
  ...
  queryIntRate: 'https://rmb-stg2.pingan.com.cn:6443/bron/ibank/cust/bron-ibank-pd/dhtCommon/queryIntRate.do',
  getSystemDateTime: 'https://rmb-stg.pingan.com.cn/bron/ibank/cust/bron-ibank-pd/fund/getSystemDateTime.do',
  mylivedeadCard: 'https://rmb-stg2.pingan.com.cn:6443/bron/ibank/cust/bron-ibank-pd/dhtCommon/checkLogin/dhtQueryCardList.do',
  ...
  exchangeDetailCheck : hostname[ENV].static + '/exchange_detail.html?check=2',
  withdrawPage: hostname[ENV].static + '/withdraw.html',
  withdrawResult: hostname[ENV].static + '/withdraw_result.html',
  recordsList:hostname[ENV].static + '/records_list.html',
  mylivedead: hostname[ENV].static + '/mylivedead.html',
    // 定活通存入页
  deposit_buy: hostname[ENV].static + '/deposit_buy.html',
  deposit_agreement: hostname[ENV].static + '/deposit_agreement.html',
  //定活通常见问题一
  deposit_commonProblemsOne: hostname[ENV].static + '/deposit_commonProblemsOne.html',
  //定活通常见问题二
  deposit_commonProblemsTwo: hostname[ENV].static + '/deposit_commonProblemsTwo.html',
  //定活通常见问题三
  deposit_commonProblemsThree: hostname[ENV].static + '/deposit_commonProblemsThree.html',
    // 定活通存入成功页
  deposit_success: hostname[ENV].static + '/deposit_success.html',
    // 搜索
